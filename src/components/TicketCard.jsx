...
export default function TicketCard({ ticket }) {
  return (
    <div className="border-2 border-gray-700 bg-black/50 p-6 flex flex-col items-center text-center hover:border-brand-500 transition-all duration-300 group">
      ...
      <span className="text-4xl font-black text-brand-400 mb-4">
        {ticket.price}
      </span>
      ...
      <a
        ...
        className={`w-full py-3 px-6 text-center font-black uppercase tracking-wider text-sm transition-all duration-300 ${
          ticket.soldOut
            ...
            : "bg-brand-500 text-white hover:bg-brand-600 hover:shadow-[0_0_20px_rgba(47,155,214,0.4)]"
        }`}
      >
